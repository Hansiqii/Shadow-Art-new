...
#      'lr': 1e-4}
# ])
torch.save({'model.state_dict': model.state_dict(), 'optimizer.state_dict': optimizer.state_dict()}, "New.pth")

loss, draw_loss, real_figure_loss = train(current_dir, device, model, optimizer, torch.nn.MSELoss(reduction="mean"), epochs=30, batches=300000, beta_1 = 0.001, beta_2 = 0.05, beta_3 = 1e-4, beta_4 = 0, beta_5 = 0, beta_6 = 1e-4)
